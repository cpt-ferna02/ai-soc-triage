...
| GoPhish | Phishing simulation — generates alerts | Free / Open Source |
| Mailhog | Local SMTP server | Free / Open Source |
| Kali Linux 2026.1 | Lab operating system | Free |
...
> [github.com/cpt-ferna02/splunk-phishing-lab](https://github.com/cpt-ferna02/splunk-phishing-lab)
...
The system will:
1. Pull the 10 most recent alerts from Splunk
2. Send each one to Claude AI for analysis
3. Print structured triage reports to the terminal
4. Save all reports to `triage_report.txt`
...
- **[Phishing Detection Lab](https://github.com/cpt-ferna02/splunk-phishing-lab)** — GoPhish + Mailhog + Splunk phishing simulation and detection
...
Built as an advanced cybersecurity portfolio project demonstrating AI integration, SOC automation, SIEM engineering, and prompt engineering for security use cases.
